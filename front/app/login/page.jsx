      ...
      <div className="flex flex-1 items-center justify-center p-6 lg:w-1/2">
        <div className="w-full max-w-md space-y-8">
          <h1 className="text-4xl font-bold tracking-tight text-[#121619]">
            Sign <span className="text-[#4218ff]">In</span>
          </h1>
          ...
          <form className="space-y-6">
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <label htmlFor="remember-me" className="text-sm text-[#21272a]">
                Remember Me
              </label>
            </div>
          ...
          <div className="relative my-4">
            ...
            <div className="relative text-center text-sm text-[#697077] bg-white px-2">
              or
            </div>
          </div>
