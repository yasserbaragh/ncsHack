          ...
          <form className="space-y-6" onSubmit={handleSignup}>
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div className="space-y-2">
                ...
                <InputText id="first-name" value={firstName} onChange={(e) => setFirstName(e.target.value)} placeholder="Enter your first name" required className={`w-full border-0 bg-[#f1ecff] text-black rounded-lg py-2 px-3 focus:ring-2 focus:ring-[#4218ff] ${inputPlaceholderClass}`} />
              </div>
              <div className="space-y-2">
                <label htmlFor="last-name" className={labelClass}>Last name</label>
                <InputText id="last-name" value={lastName} onChange={(e) => setLastName(e.target.value)} placeholder="Enter your last name" required className={`w-full border-0 bg-[#f1ecff] text-black rounded-lg py-2 px-3 focus:ring-2 focus:ring-[#4218ff] ${inputPlaceholderClass}`} />
              </div>
            </div>
